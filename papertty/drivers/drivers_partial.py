...
class EPD3in7(WavesharePartial):
    """Waveshare 3.7" monochrome"""
    def __init__(self):
        super().__init__(name='3.7"', width=280, height=480)
    
    #originally lut_1Gray_GC
    lut_full_update  = [
    ...
    #faster update mode not used in sample code
    lut_1Gray_A2  = [
        0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
